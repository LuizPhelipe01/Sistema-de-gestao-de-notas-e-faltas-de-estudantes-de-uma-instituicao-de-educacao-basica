...
Este é um script em Python desenvolvido para o gerenciamento de notas e frequência de alunos do **Ensino Fundamental 1**. O sistema calcula médias bimestrais, valida critérios de aprovação com base na frequência e notas, e gera um relatório final detalhado.
